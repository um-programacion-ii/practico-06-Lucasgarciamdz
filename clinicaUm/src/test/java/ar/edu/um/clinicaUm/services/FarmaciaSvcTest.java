...
public class FarmaciaSvcTest {
	...
	public void comprarMedicamento() throws FarmaciaEx, InterruptedException, ExecutionException {
		...
		when(farmaciaRepoMock.getMedicamento(medicamento)).thenReturn(new AbstractMap.SimpleEntry<>(medicamento, 1));
	...
	@Test
	public void comprarMedicamentoFromDrogueria() throws FarmaciaEx, InterruptedException, ExecutionException {
		MedicamentoDto medicamento = new MedicamentoDto("Ibupirac", "Ibuprofeno", "Bayer", "200mg", "100");
		Map<Integer, MedicamentoDto> medicamentos = new HashMap<>();
